...
void ChatLogic::LoadAnswerGraphFromFile(std::string filename)
{
    ...
    ChatBot cb("../images/chatbot.png"); // create instance of chatbot
    cb.SetChatLogicHandle(this);     // add pointer to chatlogic so that chatbot answers can be passed on to the GUI
    cb.SetRootNode(rootNode); // add chatbot to graph root node
